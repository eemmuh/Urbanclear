...
def check_prerequisites():
    ...
    if shutil.which("node") is None:
        print("⚠️  Node.js not found. Dashboard will not work without it.")
    else:
        print("✅ Node.js found")
    
    # Check Docker (optional)
    if shutil.which("docker") is None:
        print("⚠️  Docker not found. Some features may not work.")
    else:
        print("✅ Docker found")
...
def setup_dashboard():
    ...
    if not dashboard_dir.exists():
        print("⚠️  Dashboard directory not found, skipping dashboard setup")
        return True
    
    print("\n🖥️  Setting up React dashboard...")
...
def create_config_file():
    ...
    if example_config.exists():
        ...
        print("⚠️  No example config found. Create config/config.yaml manually.")
