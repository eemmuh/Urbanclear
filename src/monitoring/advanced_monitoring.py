...
class HealthCheckManager:
    ...
    def get_service_status(self) -> Dict[str, Any]:
        ...
        recent_results = {}
        for result in self.results[-len(self.checks):]:  # Latest results for each service
...
class AlertManager:
    ...
    def get_alert_summary(self) -> Dict[str, Any]:
        ...
        for severity in AlertSeverity:
            by_severity[severity.value] = len([a for a in active_alerts if a.severity == severity])
        
        by_type = {}
        for alert_type in AlertType:
            by_type[alert_type.value] = len([a for a in active_alerts if a.alert_type == alert_type])
...
class AdvancedMonitoringSystem:
    ...
    def _setup_default_health_checks(self):
        ...
        self.health_checks.register_check("system_resources", system_resources_check, 30)
...
async def main():
    ...
    monitoring_system.alerts.add_notification_channel('email', {
