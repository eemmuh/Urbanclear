...
class TestTrafficEndpoints:
    ...
    def test_get_current_traffic_success(self, test_client, sample_traffic_data):
        ...
        with patch('src.data.traffic_service.TrafficService.get_current_conditions') as mock_service:
            ...
            first_item = data[0]
            expected_keys = ["sensor_id", "location", "speed", "volume", "density", "severity", "timestamp"]
    ...
    @pytest.mark.api
    def test_get_current_traffic_with_location_filter(self, test_client, sample_traffic_data):
    ...
    def test_get_traffic_predictions_success(self, test_client):
        ...
        with patch('src.models.prediction.TrafficPredictor.predict') as mock_predictor:
            ...
            response = test_client.get("/api/v1/traffic/predict?location=Central Park&hours_ahead=2")
            assert response.status_code == 200
            ...
            prediction = data[0]
            expected_keys = ["timestamp", "location", "predicted_speed", "predicted_volume", "confidence"]
    ...
    def test_get_traffic_predictions_invalid_hours(self, test_client):
        ...
        response = test_client.get("/api/v1/traffic/predict?location=Central Park&hours_ahead=25")
    ...
    def test_optimize_route_success(self, test_client):
        ...
        mock_response = {
            ...
            "waypoints": [
                ...
                {"latitude": 40.7505, "longitude": -73.9934, "instruction": "Destination"}
            ]
        }
        
        with patch('src.models.optimization.RouteOptimizer.optimize_route') as mock_optimizer:
            ...
            data = response.json()
            expected_keys = ["route_id", "total_distance", "estimated_time", "optimization_score", "waypoints"]
            assert_response_structure(data, expected_keys)
...
class TestIncidentEndpoints:
    ...
    def test_get_active_incidents_success(self, test_client, sample_incident_data):
        ...
        with patch('src.models.incident_detection.IncidentDetector.get_active_incidents') as mock_detector:
            ...
            incident = data[0]
            expected_keys = ["id", "type", "severity", "location", "description", "reported_at", "status"]
    ...
    def test_get_active_incidents_with_filters(self, test_client, sample_incident_data):
        ...
        with patch('src.models.incident_detection.IncidentDetector.get_active_incidents') as mock_detector:
            ...
            response = test_client.get("/api/v1/incidents/active?location=42nd St&severity=high")
            assert response.status_code == 200
    ...
    def test_create_incident_report_success(self, test_client):
        ...
        with patch('src.models.incident_detection.IncidentDetector.create_incident') as mock_detector:
...
class TestAnalyticsEndpoints:
    ...
    def test_get_analytics_summary_success(self, test_client):
        ...
        with patch('src.data.traffic_service.TrafficService.get_analytics_summary') as mock_service:
            ...
            data = response.json()
            expected_keys = ["total_vehicles", "average_speed", "congestion_level", "incidents_count"]
            assert_response_structure(data, expected_keys)
    ...
    def test_get_performance_metrics_success(self, test_client):
        ...
        with patch('src.data.traffic_service.TrafficService.get_performance_metrics') as mock_service:
            mock_service.return_value = mock_metrics
            
            response = test_client.get("/api/v1/analytics/performance?metric_type=congestion")
            assert response.status_code == 200
...
class TestSignalEndpoints:
    ...
    def test_optimize_signals_success(self, test_client):
        ...
        with patch('src.data.traffic_service.TrafficService.optimize_signals') as mock_service:
            mock_service.return_value = mock_response
            
            response = test_client.post("/api/v1/signals/optimize", json=optimization_request)
            assert response.status_code == 200
            
            data = response.json()
            expected_keys = ["intersection_id", "optimization_score", "recommended_timing", "estimated_improvement"]
            assert_response_structure(data, expected_keys)
    ...
    def test_get_signal_status_success(self, test_client):
        ...
        with patch('src.data.traffic_service.TrafficService.get_signal_status') as mock_service:
            mock_service.return_value = mock_status
            
            response = test_client.get("/api/v1/signals/status?intersection_id=intersection_123")
            assert response.status_code == 200
            
            data = response.json()
            expected_keys = ["intersection_id", "status", "current_phase", "time_remaining"]
            assert_response_structure(data, expected_keys)
...
class TestAdminEndpoints:
    ...
    def test_retrain_models_success(self, test_client):
        ...
        with patch('src.models.prediction.TrafficPredictor.retrain') as mock_retrain:
            ...
            response = test_client.post("/api/v1/admin/models/retrain?model_type=traffic_prediction")
            assert response.status_code == 200
    ...
    def test_system_stats_success(self, test_client):
        ...
        with patch('src.data.traffic_service.TrafficService.get_system_stats') as mock_service:
            ...
            data = response.json()
            expected_keys = ["uptime", "active_sensors", "data_points_processed", "prediction_accuracy"]
            assert_response_structure(data, expected_keys)
